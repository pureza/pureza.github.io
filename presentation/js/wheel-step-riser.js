...
function wheelStepRiserSimulation() {
...
//        return y0 * exp(-m * (θ + π/2));
        ...
        function animate(wheel) {
            wheel.transition()
                ...
                .duration((110 - speed) * 30) // When speed = 100, it takes 1 second
                .ease('linear')
                .transition()
                .attrTween('transform', reverse(tween))
                .duration((110 - speed) * 30)
                .ease('linear')
                .each('end', function () {
                    animate(wheel);
                });
        ...
        return {
            ...
            draw: function (world) {
                ...
                var petalGenerator2 = d3.svg.line()
                    .x(function (d, i) {
                        return polar2x(r(angle2(i)), angle2(i));
                    })
                    .y(function (d, i) {
                        return -polar2y(r(angle2(i)), angle2(i));
                    })
                    .interpolate('linear');
